...
The [shared responsibility model](https://aws.amazon.com/compliance/shared-responsibility-model/) divides into customer responsibilities (commonly referred to as “security in the cloud”) and AWS responsibilities (commonly referred to as “security of the cloud”).
...
![IAM Policies](../img/iam_policies.png)
...
![AWS Organizations](../img/aws_orgs.png)
...
![AWS Organizations 2](../img/aws_orgs2.png)
...
![AWS Organizations 3](../img/aws_orgs3.png)
...
![DDoS Attack](../img/ddos_attack.png)
...
![AWS GuardDuty](../img/guardduty.png)
